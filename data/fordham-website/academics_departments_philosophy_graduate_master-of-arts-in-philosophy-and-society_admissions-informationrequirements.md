https://www.fordham.edu/academics/departments/philosophy/graduate/master-of-arts-in-philosophy-and-society/admissions-informationrequirements

# M.A. in Philosophy and Society Admissions Information

## Guidelines and information

GSAS will waive all application fees from members of the Society of Jesus to the

M.A. in Philosophy and Society (MAPS) program.

Completed [online application](https://gradadmissions.fordham.edu/portal/gsas_application) for the MAPS program will include each of the following items:
...
GRE scores for the M.A. program are optional. Applicants who wish to submit GRE scores may do so, but scores are not required (scores should be sent directly by the testing service to the Office of Graduate Admissions, Fordham University, Graduate School of Arts and Sciences – Code #2259).

**Statement of intent**

Up to 500 words, submit via the [online application](https://gradadmissions.fordham.edu/portal/gsas_application).
...
5 - 20 pages in length, submit via the [online application](https://gradadmissions.fordham.edu/portal/gsas_application).
