https://www.fordham.edu/academics/departments/psychology/graduate-program/master-of-science-in-clinical-research-methods/admissions-informationrequirements

# M.S. in Clinical Research Methods Admissions Information

## Guidelines and Information

Requirements for admission are a B.A. or B.S. from accredited university (or international equivalent). Some undergraduate Psychology coursework is beneficial but not required. In fact, the program is ideally suited to an applicant with strong research potential but who is lacking in either Psychology coursework or research experience (or both). In addition an undergraduate transcript, all applicants are required to submit three letters of recommendation, their current curriculum vitae, and complete the [Graduate School of Arts and Sciences on-line application](https://gradadmissions.fordham.edu/apply/).

Submission of GRE scores is optional for the M.S. program. While there is no minimum requirement for either GRE scores or undergraduate GPA, based on applications to other psychology programs, we anticipate that top applicants who choose to submit GRE scores will have scores above the 60th percentile on each subtest and an undergraduate GPA of at least 3.30.
...
GRE scores are optional for the M.S program. Applicants who wish to submit GRE scores may do so, but scores are not required (scores should be sent directly by the testing service to the Office of Graduate Admissions, Fordham University, Graduate School of Arts and Sciences – Code #2259).
...
Please contact [[email protected]](/cdn-cgi/l/email-protection#791f0c1e18391f160b1d111814571c1d0c) with any admissions-related questions.

**For Additional Information**

General inquiries regarding the master’s program should be directed to Andrew Rasmussen, Ph.D., Graduate Program Director, at [[email protected]](/cdn-cgi/l/email-protection#c8a9baa9bba5bdbbbbada688aea7baaca0a9a5e6adacbd). For information or questions regarding the application process, tuition and fees, or other matters related to the university, contact the Admissions Office of the Graduate School of Arts and Sciences at [[email protected]](/cdn-cgi/l/email-protection#1d7b687a7c5d7b726f79757c7033787968).