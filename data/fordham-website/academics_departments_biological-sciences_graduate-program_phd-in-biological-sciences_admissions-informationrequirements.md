https://www.fordham.edu/academics/departments/biological-sciences/graduate-program/phd-in-biological-sciences/admissions-informationrequirements

# Ph.D. in Biological Sciences Admissions Information/Requirements

## Guidelines and Information

Completed applications to the Ph.D. in Biological Sciences will include each of the following items:

**Resume**

Submitted directly via the [online application](https://gradadmissions.fordham.edu/apply/).

**Statement of intent**

The "Statement of Intent" for the Ph.D. in Biology requires students to answer the following questions and also imposes a 300 word maximum for each question.
...
Recommended not required. Please see the above statement on the GRE scores.
...
| DET | 130 |
| PTE Academic | 68 |
| Cambridge English Qualifications | 185 Overall Score on the B2 First, C1 Advanced, or C2 Proficiency exam |
...
Contact [[email protected]](/cdn-cgi/l/email-protection#a4c2d1c3c5e4c2cbd6c0ccc5c98ac1c0d1) with any admission-related questions.