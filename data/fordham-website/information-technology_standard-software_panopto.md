https://www.fordham.edu/information-technology/standard-software/panopto
...
Panopto is intended for active videos. A video is considered active as long as someone (whether the owner or a viewer) has accessed it. Storage on Panopto is limited by the amount of time it exists without being accessed, as opposed to space.**For videos that are meeting recordings ported over from Zoom:**

If no one accesses the video, it remains available for 24 months.

After that, it remains in a recycle bin for 3 months.

If the owner does not restore it from the recycle bin, it is automatically deleted.**For all other videos:**
...
Access Panopto from Blackboard, or My Apps on the Portal at fordham.edu, or at [Fordham.hosted.panopto.com](http://fordham.hosted.panopto.com/). Consult Panopto's support pages for [system requirements](https://support.panopto.com/s/article/System-Requirements).
...
When you record an online meeting to the cloud using your [Fordham Zoom account](http://fordham.zoom.us/), the recording is automatically sent to the Meeting Recordings folder in your Panopto account.

**Zoom vs Panopto**

Use Panopto to record a lecture for asynchronous viewing. Panopto is *not* a replacement for a live [Zoom](/information-technology/standard-software/virtual-classes-and-meetings/zoom-services/) meeting for a synchronous class. See [fordham.edu/zoom](/information-technology/standard-software/virtual-classes-and-meetings/zoom-services/) for more information.
...
Sign up for [upcoming Panopto workshops](https://itnews.blog.fordham.edu/?post_type=tribe_events&tribe_event_display=month&post_type=tribe_events&eventDisplay=month&tribe-bar-date=2020-08&tribe-bar-search=panopto), given by Office of Information Technology staff.

[Frequently Asked Questions](https://docs.google.com/document/d/1NXwi3489ngHxSNBxFBftlufEELgcZjOuh3SCqePTkZc/edit)[Using Panopto with Blackboard](https://docs.google.com/document/d/1ycnyF3OvpWwBvWW0VcwcJ6HgVgHTdUplDsNDw-GT3qg/view)[Getting started with Panopto](https://support.panopto.com/s/topic/0TO390000003VN8GAM/getting-started-with-panopto-enterprise)[Record a video](https://support.panopto.com/s/article/Record-a-Video)[Upload a video](https://support.panopto.com/s/article/Batch-Upload-Video-Files)[Add automatic captions to a video](https://howtovideos.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=610849cd-1349-4128-a37f-ab9a0151b933&query=blackboard%20closed%20caption)[Edit a video](https://support.panopto.com/s/getting-started-video?topic=Edit+A+Video)


If you need support or have questions, contact the [IT Service Desk](/information-technology/it-services/technology-support/).