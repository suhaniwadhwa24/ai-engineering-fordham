https://www.fordham.edu/academics/departments/psychology/graduate-program/master-of-science-in-applied-psychological-methods/admissions-informationrequirements

# M.S. in Applied Psychological Methods Admissions Information

## Guidelines and Information

Requirements for admission are a B.A. or B.S. from an accredited university (or international equivalent). Some undergraduate Psychology coursework is required; this coursework must include statistics.

Submission of GRE scores are optional for the M.S. program. While there is no minimum requirement for either GRE scores or undergraduate GPA, based on applications to other psychology programs, we anticipate that top applicants who choose to submit GRE scores will have scores above the 60th percentile on each subtest and an undergraduate GPA of at least 3.30.

### Required Materials for Application

**Statement of intent**

Up to 500 words, double spaced submitted electronically via the online application.
...
10 - 20 pages submitted electronically, via the online application.
...
GRE scores are optional for M.S. program. Applicants who wish to submit GRE scores may do so, but scores are not required (scores should be sent directly by the testing service to the Office of Graduate Admissions, Fordham University, Graduate School of Arts and Sciences – Code #2259).
...
Please refer to the [Graduate School of Arts and Sciences Admissions](/graduate-school-of-arts-and-sciences/admissions/) for further clarification, or send admissions questions to [[email protected]](/cdn-cgi/l/email-protection#c2a4b7a5a382a4adb0a6aaa3afeca7a6b7)

If you need assistance filling out or submitting the [online application](https://gradadmissions.fordham.edu/apply/) please contact GSAS Admissions at 718-817-4416.