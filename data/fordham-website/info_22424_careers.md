...
For further information regarding programs being held, and to register to attend a program, go to [Symplicity](https://my.lawnet.fordham.edu/sites/careerservicesforjdalumni/SitePages/Symplicity.aspx) and select the "Events" section via the side navigation bar, then select "Workshop" and click on the "CPC Programs" tab to register. If you missed a CPC program you are encouraged to visit the CPC Past Programs link to listen to the streaming audio or watch the streaming video.

Events at Fordham Law
...
Career Planning Center Job Search Guides and Career Development Materials