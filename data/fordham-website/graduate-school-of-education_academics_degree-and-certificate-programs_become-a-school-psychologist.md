https://www.fordham.edu/graduate-school-of-education/academics/degree-and-certificate-programs/become-a-school-psychologist
...
[Advanced Certificate in Bilingual School Psychology (ADV CER BIL)](/graduate-school-of-education/academics/degree-and-certificate-programs/become-a-school-psychologist/advanced-certificate-in-bilingual-school-psychology/)
...
[Advanced Certificate in School Psychology (ADV CER)](/graduate-school-of-education/academics/degree-and-certificate-programs/become-a-school-psychologist/advanced-certificate-in-school-psychology/)
...
-
**GENERAL INFORMATION AND OVERVIEW****What programs does Fordham offer in School Psychology?**- Fordham offers three programs in school psychology; two at the advanced certificate level (ADV CER, ADV CER BIL), and one at the doctoral level.
...
**Do all programs lead to certification and/or licensure in New York State?**- Our Advanced Certificate programs lead to certification as a school psychologist in New York. Graduates of our certificate programs are also eligible to become certified at the national level (NCSP). These programs do NOT lead to licensure.
...
**What is the difference between “Advanced Certificate” and Ed.S. programs?**- New York State does not recognize Ed.S. (“educational specialist") degrees. Rather, to be certified as a school psychologist in New York, you must have a M.S.E. degree and an “advanced certificate” in school psychology or bilingual school psychology.
...
**What master’s degrees do you offer?**- All students accepted to our school psychology programs are automatically accepted to the captured masters option of their choice. The masters options are considered "captured masters" -- they are only open to students in the ADV CER, ADV CER BIL, or Ph.D. programs.
...
-
Educational Evaluation & Intervention
...
**As a Ph.D. applicant, do I need to contact a faculty member in advance to see if they are accepting new doctoral students?**- Although you are always welcome to contact any faculty member in the program, we do not admit students based upon the possibility of working with a particular faculty member, but to the program itself. We welcome your application!
- During the first year in the program, you will have the opportunity to hear about the research of all faculty members in the program, as well as those in the Division of PES, before selecting a faculty member as your research mentor. You can find a list of our faculty members and their research interests
[here](/graduate-school-of-education/faculty/directory/).

**What time are classes?**- Classes are either from 4:50-6:50 p.m. or 7-9 p.m., Mon-Thurs.
- During the first year only, there is a proseminar class that starts at 3:15 p.m.

**Is it possible to do the program and work full-time?**- Faculty can provide an endorsement letter for your employer detailing course schedules to excuse you, but you would have to negotiate hours with your employer. See above for when courses are typically held.
...
**How long will it take to complete the program?**- For the certificate programs, if you attend the program full-time, the expected time to completion is three years (roughly two years of coursework and one year of internship).
...
**TEST SCORES AND PREREQUISITES****Is the GRE required? How much importance is given to the GRE test scores?**- For this academic year, we have decided to make the GRE optional for applicants to the Ph.D. program. The GRE is not required for ADV CER or ADV CER BIL applicants.
...
**Is the TOEFL or IELTS required?**- All applicants for all programs whose native language is not English and who did not attend an undergraduate institution in a country where the official language is English must submit an original TOEFL or IELTS test score report.
- TOEFL Code: 2252
- IELTS scores can be sent to 113 W60th Street, Suite 1108, NY, NY 10023
- Please review further information
[here](/graduate-school-of-education/admissions/international-students/#d.en.34582).

**What are the required prerequisite courses?**- Prerequisite Courses:
...
**Is there a test required for the Advanced Certificate Bilingual program?**- Students who seek the bilingual extension must sit for the New York State Bilingual Education Assessment (BEA), which assesses knowledge and skills in the foundations of bilingual education, including listening and reading comprehension and written and oral expression. The BEA is offered in the target language of the certificate extension sought, and consists of multiple-choice questions, audiotaped listening and speaking components in English and the target language, and reading and writing components in the target language.
...
**Is it possible to start in the ADV CER program and transfer into Fordham’s Ph.D. program?**- Yes, it is possible but you will have to start a new application, as these are two different programs.
...
**FINANCING YOUR EDUCATION****What is the typical funding structure for students in the program?**-
For information regarding the Graduate School of Education’s financial aid, please visit our

[financial aid](/graduate-school-of-education/admissions/tuition-and-financial-aid/financial-aid/#d.en.34688)and[scholarship](/graduate-school-of-education/admissions/tuition-and-financial-aid/financial-aid/scholarships/#d.en.34696)pages. There are additional scholarships and other opportunities available. Information can be found[here](/graduate-school-of-education/admissions/tuition-and-financial-aid/#d.en.34680). -
For information regarding financial aid for persons employed as full-time professionals in Catholic or other religiously affiliated nonpublic schools,

[click here](/graduate-school-of-education/centers-and-institutes/the-center-for-catholic-school-leadership-and-faith-based-education/scholarship/#d.en.34566). - NYC DOE PIT
- NYC DOE Scholarship
- For information regarding our ADV CER program in school psychology,
[click here](/graduate-school-of-education/academics/degree-and-certificate-programs/become-a-school-psychologist/advanced-certificate-in-school-psychology/#d.en.35168). - For information regarding our ADV CER program in bilingual school psychology
[click here](/graduate-school-of-education/academics/degree-and-certificate-programs/become-a-school-psychologist/advanced-certificate-in-bilingual-school-psychology/#d.en.35180). - For information regarding our Ph.D. program in school psychology,
[click here](/graduate-school-of-education/academics/degree-and-certificate-programs/become-a-school-psychologist/school-psychology-phd/#d.en.35196). - Find more information in the GSE Bulletin, including program overviews, admissions information, and program requirements, by clicking
[here](https://bulletin.fordham.edu/gse/school-psychology/).