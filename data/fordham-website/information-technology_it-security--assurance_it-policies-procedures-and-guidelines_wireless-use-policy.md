https://www.fordham.edu/information-technology/it-security--assurance/it-policies-procedures-and-guidelines/wireless-use-policy
...
- User authentication is required before accessing the 'Fordham' or
[eduroam](https://eduroam.org/about/connect-yourself/)wireless networks.[1](#1) - The FordhamGuest (non-authenticated wireless service) provides visitors with unprotected and insecure access to the Internet for basic web browsing and is limited to Internet-available services.
...
Consult the web page[1](#1.1)[Campus Wifi](/information-technology/it-services/campus-wifi/)for detailed instructions on connecting to the new network on your particular device or operating system.
